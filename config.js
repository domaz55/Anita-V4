...
// Owner & Bot Details
global.owner = process.env.OWNER_NUMBER;"263785439377"
global.anitav4 = process.env.BOT_NAME || "PRINCE_MD";
global.ownername = process.env.OWNER_NAME || "PRINCE";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "PRINCE";
global.channelname = process.env.CHANNEL_NAME || "PRINCE";
